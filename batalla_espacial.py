...
class Jugador(pygame.sprite.Sprite):
    ...
    def update(self, teclas):
        """Mueve la nave según las teclas presionadas, sin salir de la pantalla."""
...
# ===========================================================
def pantalla_seleccion_dificultad():
...
def jugar(dificultad):
    ...
    while jugando:
        ...
        if teclas[pygame.K_SPACE] and tiempo_actual - tiempo_ultimo_disparo > jugador.obtener_cooldown_disparo():
...
def main():
    while True:
        pantalla_inicio()
        dificultad = pantalla_seleccion_dificultad()
        puntuacion_final = jugar(dificultad)
        pantalla_game_over(puntuacion_final)
